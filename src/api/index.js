...
// 1、基础路径
const BASE_URL = 'https://154.83.12.64:3000'
...
// 2.12 加入购物车
export const addGoodsToCart = (user_id, goods_id, goods_name, thumb_url, price) => http(BASE_URL + '/api/add_shop_cart', {user_id, goods_id, goods_name, thumb_url, price}, 'POST');
// 2.13 请求购物车的数据
export const getCartsGoods = () => http(BASE_URL + '/api/cart_goods');
